[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(BasicAPI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(BasicAPI.App_Start.NinjectWebCommon), "Stop")]
...
namespace BasicAPI.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            var modules = new INinjectModule[] { new DependencyRegistrar(configurationSettings) };
